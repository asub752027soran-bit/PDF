...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    tool_image_to_url_name: "Image to URL Converter",
    tool_image_to_url_desc: "Convert images to Data URL, Base64 URI, HTML <img> embed tags, CSS backgrounds, and test links.",
  ...
  es: {
    ...
    tool_image_to_url_name: "Convertidor de Imagen a URL",
    tool_image_to_url_desc: "Convierte imágenes a Data URL, Base64, etiquetas HTML <img>, fondos CSS y enlaces de prueba.",
  ...
  fr: {
    ...
    tool_image_to_url_name: "Convertisseur Image en URL",
    tool_image_to_url_desc: "Convertissez des images en Data URL, Base64, balises HTML <img>, arrière-plans CSS et liens de test.",
  ...
  de: {
    ...
    tool_image_to_url_name: "Bild-zu-URL-Konverter",
    tool_image_to_url_desc: "Konvertieren Sie Bilder in Data-URLs, Base64, HTML-<img>-Tags, CSS-Hintergründe und Testlinks.",
